...
--
-- Host: 192.168.10.2    Database: tbtogetherdb
-- ------------------------------------------------------
...
myproc:BEGIN    
    ...
    insert into Users(userLogin,userPassword,userName,userAddress,userCity,userCountry)
    values (pCreatorID ,
	puserLogin ,
	puserPassword ,
	puserName ,
...
-- Dump completed on 2019-03-06 11:53:54
